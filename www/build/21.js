...
var WelcomePage = (function () {
    ...
    WelcomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-welcome',template:/*ion-inline-start:"/Users/pandiyanchandrasegar/viz-mobile-app/src/pages/welcome/welcome.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-title>\n            Welcome!\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <span class="hipster"></span>\n	<div class="center">\n  <p class="party-font">Natham R Viswanathan</p>\n  </div>\n    <div class="center">\n        <button ion-button block (click)="login()" class="login">{{ \'LOGIN\' | translate }}</button>\n\n        <p>Don\'t have an account yet?</p>\n        <button ion-button block (click)="signup()">{{ \'SIGNUP\' | translate }}</button>\n		<br/>\n		<a (click)="skip()" style="border-bottom: 1px solid;"> Skip now, I will sign up later</a>\n    </div>\n</ion-content>\n'/*ion-inline-end:"/Users/pandiyanchandrasegar/viz-mobile-app/src/pages/welcome/welcome.html"*/
        }),
